...
public class MinHash<T> {
	public final static String PATH = "C:\\Users\\Mudit\\Documents\\NetBeansProjects\\Duplication Checking\\resource\\";
	...
	private int NumSets;
	public MinHash(List<Set<T>> Sets)
	{
	...
	public static void main(String[] args) {
		...
		MinHash<String> res = new MinHash<String>(CompleteSet);
